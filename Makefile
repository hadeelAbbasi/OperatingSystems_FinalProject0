...
milestone7:
	$(CC) $(CFLAGS) milestone7/main_m7.c milestone7/graph.c milestone7/dijkstra.c milestone7/ipc.c milestone7/scheduler.c milestone7/gui.c -o sim -lraylib -lm -ldl -lpthread -lGL -lrt -lX11
